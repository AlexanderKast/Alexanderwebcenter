...
export const metadata: Metadata = {
  title: "Podcast",
  description: "Conversaciones reales sobre negocios digitales, IA aplicada y mentalidad para emprendedores LATAM. Sin filtros.",
};
...
export default function PodcastPage() {
  return (
    <>
      <PageHero
        overline="CONVERSACIONES REALES"
        title="PODCAST"
