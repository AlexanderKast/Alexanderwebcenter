# Análisis: @ramiro.cubria (Instagram)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-4-contenido
**Nombre:** Ramiro Cubria
**Followers (plataforma principal):** 443K IG
...
```
python scripts/apify-scraper.py --platform instagram --handle ramiro.cubria --pilar 4 --top-n 5 --min-views 500000
```
