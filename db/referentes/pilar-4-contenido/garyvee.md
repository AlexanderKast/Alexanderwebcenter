# Análisis: @garyvee (Instagram)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-4-contenido
**Nombre:** Gary Vaynerchuk
**Followers (plataforma principal):** 12M IG
...
```
python scripts/apify-scraper.py --platform instagram --handle garyvee --pilar 4 --top-n 5 --min-views 500000
```
