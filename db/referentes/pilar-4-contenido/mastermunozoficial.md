# Análisis: @mastermunozoficial (Instagram)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-4-contenido
**Nombre:** Carlos Master Muñoz
**Followers (plataforma principal):** 1M IG (cross P1+P2)
**Plataforma principal scrapeable:** instagram
...
```
python scripts/apify-scraper.py --platform instagram --handle mastermunozoficial --pilar 4 --top-n 5 --min-views 500000
```
