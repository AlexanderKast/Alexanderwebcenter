# Análisis: @bruno.ia1 (Instagram)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-2-ia-aplicada
**Nombre:** Bruno Pereira
**Followers (plataforma principal):** 201K IG
...
```
python scripts/apify-scraper.py --platform instagram --handle bruno.ia1 --pilar 2 --top-n 5 --min-views 500000
```
