...
**Followers (plataforma principal):** 1M IG (cross P1)
...
```
python scripts/apify-scraper.py --platform instagram --handle mastermunozoficial --pilar 2 --top-n 5 --min-views 500000
```
