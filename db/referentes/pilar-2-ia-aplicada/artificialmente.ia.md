# Análisis: @artificialmente.ia (Instagram)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-2-ia-aplicada
**Nombre:** Artificialmente IA
**Followers (plataforma principal):** 256K IG
...
```
python scripts/apify-scraper.py --platform instagram --handle artificialmente.ia --pilar 2 --top-n 5 --min-views 500000
```
