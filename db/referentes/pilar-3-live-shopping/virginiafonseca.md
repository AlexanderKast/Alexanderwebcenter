# Análisis: @virginiafonseca (TikTok)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-3-live-shopping
**Nombre:** Virginia Fonseca
**Followers (plataforma principal):** 14M+ TT
...
```
python scripts/apify-scraper.py --platform tiktok --handle virginiafonseca --pilar 3 --top-n 5 --min-views 500000
```
