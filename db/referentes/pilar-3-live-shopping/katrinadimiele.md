# Análisis: @katrinadimiele (TikTok)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-3-live-shopping
**Nombre:** Katrina DiMiele
**Followers (plataforma principal):** 214K TT
...
```
python scripts/apify-scraper.py --platform tiktok --handle katrinadimiele --pilar 3 --top-n 5 --min-views 500000
```
