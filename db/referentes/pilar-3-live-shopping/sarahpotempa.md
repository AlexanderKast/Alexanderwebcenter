# Análisis: @sarahpotempa (TikTok)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-3-live-shopping
**Nombre:** Sarah Potempa (Beachwaver)
**Followers (plataforma principal):** 1.5M TT
...
```
python scripts/apify-scraper.py --platform tiktok --handle sarahpotempa --pilar 3 --top-n 5 --min-views 500000
```
