# Análisis: @meif_espinosa (TikTok)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-3-live-shopping
**Nombre:** Meif Espinosa
**Followers (plataforma principal):** ~500K TT (verificar)
**Plataforma principal scrapeable:** tiktok
...
```
python scripts/apify-scraper.py --platform tiktok --handle meif_espinosa --pilar 3 --top-n 5 --min-views 500000
```
