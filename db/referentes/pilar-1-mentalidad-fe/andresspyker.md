# Análisis: @andresspyker (Instagram)

**Fecha de creación:** 2026-05-06 (placeholder — pendiente data Apify)
**Pilar:** pilar-1-mentalidad-fe
**Nombre:** Andrés Spyker
**Followers (plataforma principal):** 615K IG
...
```
python scripts/apify-scraper.py --platform instagram --handle andresspyker --pilar 1 --top-n 5 --min-views 500000
```
